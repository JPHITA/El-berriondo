INSERT INTO usuarios (documento, nombre, apellido, email, password, fecha_registro, privilege) VALUES
(123, 'Don', 'Berriondo', 'admin@admin.com', 'admin', NOW(), True),
(321, 'Juan', 'Perez', 'user@user.com', 'user', NOW(), FALSE);
